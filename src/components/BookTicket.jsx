...
const BookTicket = () => {
  ...
  // console.log("GETITEM ID:" + loginID);
  ...
  // console.log("GETITEM Id:" + moviebook.loginId);
  ...
  const verifybookingreq = (event) => {
    if (moviebook.noOfTickets < 1) {
      ...
      setticketbookError("Selected seat numbers can not be less than no. of tickets");
      setHasErrors(true);
      return false;
