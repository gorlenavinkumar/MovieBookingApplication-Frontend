    ...
    <div className="max-w-md mx-auto my-auto">
      ...
      <form>
        ...
        <div className="flex mb-4 py-2">
          <input type="radio" id="admin" name="RadioButton" value="admin" 
            onClick={(role) => {
              if (role) {
                setRegister({ ...register, roles: ["admin"] });
              }
          ...
          />
          <label for="RadioButton">Admin</label>
          </div>

          <div className="flex mb-4 px-4 py-2">
          <input type="radio" id="user" name="RadioButton" value="user" 
            onClick={(role) => {
              if (role) {
                setRegister({ ...register, roles: ["user"] });
              }
          ...
          />
          <label for="RadioButton">User</label>
        </div>
